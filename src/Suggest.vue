<template>
  <div :name="name">
    <input
      ...
      @focus="open"
    >
    <div class="sg-clear" @click="clear" v-show="text" v-if="!disabled">
      <span>×</span>
    </div>
...
export default {
  ...
  methods: {
    open() {
      ...
      this.populate();
      if (!this.dropShow && this.list.length)
    ...
    adjust() {
      ...
      if (this.width === 198) {
        ...
        if (inputWidth - 2 !== this.width)
          this.width = (inputWidth > 200 ? inputWidth : 200) - 2;
      }
    },
    populate() {
...
div.v-suggest {
  ...
  input[type="text"] {
    ...
    -webkit-transition: border-color ease-in-out 0.15s,
      -webkit-box-shadow ease-in-out 0.15s, background-color ease-in-out 0.15s;
